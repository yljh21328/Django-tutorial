...
class MusicViewTestCase(APITestCase):
    ...
    # url = '/api/music/'
    url = '/api/music_viewset/'
    url_detail = '/api/music_viewset/{}/'
    # url_detail_route_reverse = reverse('api:music-detail', kwargs={"pk": 1})
    url_detail_route = '/api/music_viewset/{}/detail_self/'
    url_list_route = '/api/music_viewset/all_singer/'
    ...
    def test_api_music_create(self):
        ...
        self.assertEqual(Music.objects.count(), 5)
